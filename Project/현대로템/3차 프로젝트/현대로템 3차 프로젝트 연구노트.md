...
# 연구 계획
## 1차 연구
1. 시뮬레이션 속 차체의 움직임에 대한 물리량을 측정 후 mapping
2. mapping 정보 기반 speed control
3. mapping 정보 기반 angle control
## 2차 연구 - 알고리즘
1. 시뮬레이션에 A* 적용
2. 시뮬레이션에 TRG 적용
3. 
## 3차 연구 - 규칙 기반 AI
1. 아키텍처 설계(입력 및 출력 자료형 확정)
2. 1차 과제 연구 결과 기반 조종 행동
3. 게임 AI 적용(배회하기, 추적 등)
